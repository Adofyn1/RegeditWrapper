...
#error Unsupported platform. Open an issue and Ill probably add support.
        ...
        public:
            ...
            LAZY_IMPORTER_FORCEINLINE exports_directory(const char* base) noexcept : _base( base )
            {
        ...
        struct safe_module_enumerator
        {
            ...
            LAZY_IMPORTER_FORCEINLINE safe_module_enumerator(const detail::win::LDR_DATA_TABLE_ENTRY_T* ldr) noexcept : value( ldr->load_order_next() ), head( value )
            {
            }
